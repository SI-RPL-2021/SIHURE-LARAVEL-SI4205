...
@section('content')
    <h3 style="text-align:center;color:black;font-weight:bolder;">PENGAJUAN LEMBUR</h3>
    <div class="d-flex justify-content-center" style="margin-top: 10px">
        <form action="" method="post" enctype="multipart/form-data">
            <div class="row">
                <div class="col">
                    <div class="card" style="width: 700px; height: 625px;">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="modal fade" id="yes" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            ...
                                            <div class="modal-footer">
                                                <a class="btn btn-secondary" href="/admin/pengajuan_lembur" role="button">Close</a>
